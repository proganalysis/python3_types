...
write_path = "/home/bew/Desktop/wp2/ManyFlags/"
...
for ii in range(1,28):
	...
	with open(path_repo_list_num) as fp:
		...
		while line:
			...
			command.append("--no-strict-optional")
			command.append("--no-warn-no-return")
			command.append("--allow-redefinition")
			command.append("--allow-untyped-globals")
