...
def parse_set(expression: Iterator[Tuple[str, str]], **kwargs) -> Iterator[nodes.SetNode]:
    ...
    ranges = []
    shorthands = []
#/home/bew/archive/typed_project/(nitely)regexy/regexy/compile/parse.py:71: error: Need type annotation for 'chars' (hint: "chars: List[<type>] = ...")
#/home/bew/archive/typed_project/(nitely)regexy/regexy/compile/parse.py:72: error: Need type annotation for 'ranges' (hint: "ranges: List[<type>] = ...")
#/home/bew/archive/typed_project/(nitely)regexy/regexy/compile/parse.py:73: error: Need type annotation for 'shorthands' (hint: "shorthands: List[<type>] = ...")
