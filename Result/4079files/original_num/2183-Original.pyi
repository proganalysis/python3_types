...
class Chat(`namedtuple-Chat-users-msgs-id`):
    ...
    def __new__(cls: Type[_TChat], msgs: tuple, id: Optional[int] = ...) -> _TChat: ...
    def save(self, filename: Optional[str] = ..., max_length: int = ...) -> str: ...
...
def gen_rows(path: str) -> types.GeneratorType: ...
def gen_skype_chats(path: str) -> types.GeneratorType: ...
def get_skype_map(path: str) -> collections.defaultdict: ...
def getcwd() -> str: ...
