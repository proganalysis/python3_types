...
class QPower2ModelCL(Any):
    ...
    u: Any
    def __init__(self, method: str = ..., is_secondary: bool = ..., cl_ctx = ..., cl_queue = ...) -> None: ...
    def evaluate_ps(self, k, ldc, t0, p, a, i, e = ..., w = ..., copy = ...) -> numpy.ndarray: ...
    def evaluate_pv(self, pvp: numpy.ndarray, ldc: numpy.ndarray, copy: bool = ...) -> numpy.ndarray: ...
