...
#   File "/usr/local/lib/python3.6/dist-packages/pytype/vm.py", line 1428, in _import_module
#     ast = self.loader.import_relative(level)
#   File "/usr/local/lib/python3.6/dist-packages/pytype/load_pytd.py", line 417, in import_relative
