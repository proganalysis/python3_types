...
class Leaf:
    ...
    def find(self, phoneme_list, original_string: str) -> Optional[Leaf]: ...
...
class TreeNode:
    child_leaves_count: int
    children: Dict[Any, Union[Leaf, TreeNode]]
    leaves: List[Leaf]
    total_leaves_count: Any
    def __getitem__(self, item) -> Union[Leaf, TreeNode]: ...
    def __init__(self) -> None: ...
    def find(self, phoneme_list, original_string: str) -> Any: ...
    def find_random(self) -> Any: ...
    def insert(self, leaf: Leaf, current_pho_index) -> None: ...
