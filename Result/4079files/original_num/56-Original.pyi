...
class Player(object):
    ...
    ranked_seasons: Optional[RankedSeasons]
    signature_url: Optional[str]
    stats: Optional[dict]
    uid: str
    def __init__(self, uid: str, display_name: str, platform: str, avatar_url: Optional[str] = ..., profile_url: Optional[str] = ..., signature_url: Optional[str] = ..., stats: Optional[dict] = ..., ranked_seasons: Optional[RankedSeasons] = ...) -> None: ...
