...
def build_redis_database(resource: str, is_async: bool = ...) -> Optional[Union[chattymarkov.database.databases.RedisDatabase, chattymarkov.database.databases.RedisDatabaseAsync]]: ...
def build_redis_database_async(resource: str) -> Optional[Union[chattymarkov.database.databases.RedisDatabase, chattymarkov.database.databases.RedisDatabaseAsync]]: ...
