...
class Backup(object):
    ...
    def delete_backup(self, backup_id: int) -> Coroutine[Any, Any, None]: ...
    def get_all_backups(self, limit: int, skip: int, status, sort_order = ...) -> Coroutine[Any, Any, list]: ...
    def get_backup_details(self, backup_id: int) -> Coroutine[Any, Any, dict]: ...
