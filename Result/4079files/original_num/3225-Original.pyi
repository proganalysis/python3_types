...
class AioBase(Any):
    ...
    _wsdl: Any
    transport: str
    def __init__(self, app, chunked: bool = ..., threads: Optional[int] = ...) -> None: ...
    def _handle_rpc_body(self, p_ctx) -> Any: ...
    def handle_error(self, req, p_ctx, others: list, error) -> coroutine: ...
    def handle_rpc_request(self, req, app) -> coroutine: ...
    def handle_wsdl_request(self, req, app) -> coroutine: ...
    @staticmethod
    def make_streaming_response(req, status: int, content: List[bytes], chunked: bool = ..., headers: Optional[dict] = ...) -> coroutine: ...
    def response(self, req, p_ctx, others: list, error = ...) -> coroutine: ...
