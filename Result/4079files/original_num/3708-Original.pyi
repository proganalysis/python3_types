...
# Caught error in pytype: Don't know how to match <class 'pytype.pytd.pytd.Literal'> against <class 'pytype.pytd.pytd.NamedType'>
...
#     t1, t2, subst)
#   File "/usr/local/lib/python3.6/dist-packages/pytype/pytd/type_match.py", line 363, in _match_type_against_type
...
#     for e in exprs:
#   File "/usr/local/lib/python3.6/dist-packages/pytype/pytd/type_match.py", line 363, in <genexpr>
#     for t in self.expand_subclasses(t2))
#   File "/usr/local/lib/python3.6/dist-packages/pytype/pytd/type_match.py", line 309, in match_type_against_type
#     t1, t2, subst)
#   File "/usr/local/lib/python3.6/dist-packages/pytype/pytd/type_match.py", line 396, in _match_type_against_type
#     type(t1), type(t2)))
# AssertionError: Don't know how to match <class 'pytype.pytd.pytd.Literal'> against <class 'pytype.pytd.pytd.NamedType'>