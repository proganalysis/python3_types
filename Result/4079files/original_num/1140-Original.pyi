...
def element_to_objects(element, sender: str, sender_key_fetcher: Optional[Callable[[str], str]] = ..., user = ...) -> list: ...
def get_outbound_entity(entity, private_key) -> Any: ...
def message_to_objects(message: str, sender: str, sender_key_fetcher: Optional[Callable[[str], str]] = ..., user = ...) -> list: ...
