...
class Session:
    ...
    @staticmethod
    def _generate_order(o: str, f) -> Optional[Union[float, int, str]]: ...
    ...
    def load_storage(self, ids = ...) -> Sequence: ...
    def load_view(self) -> Sequence: ...
    def request(self, f) -> None: ...
    def response(self, f) -> None: ...
    def resume(self, f) -> None: ...
    def running(self) -> None: ...
    def set_filter(self, input_filter: Optional[str]) -> None: ...
    def set_order(self, order: str) -> None: ...
    def store_count(self) -> int: ...
    def update(self, flows: Sequence) -> None: ...
