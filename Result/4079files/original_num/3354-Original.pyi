...
def get_ivysilani_playlist(url, quality: int) -> Any: ...
def get_live_playlist(channel, quality: int) -> Any: ...
def get_playlist(playlist_id, playlist_type, quality: int) -> Any: ...
def main() -> None: ...
def parse_quality(value: str) -> int: ...
def play(options) -> None: ...
def run_player(playlist, player_cmd: str) -> None: ...
