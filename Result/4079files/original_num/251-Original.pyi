...
class Driver(abc.ABC):
    @abstractmethod
    def delete(self, key: str, value) -> Coroutine[Any, Any, None]: ...
    @abstractmethod
    def expire(self, key: str, time: int) -> coroutine: ...
    @abstractmethod
    def get(self, key: str) -> coroutine: ...
    @abstractmethod
    def lpush(self, key, value) -> coroutine: ...
    @abstractmethod
    def rpop(self, key) -> coroutine: ...
    @abstractmethod
    def set(self, key: str, value) -> coroutine: ...
