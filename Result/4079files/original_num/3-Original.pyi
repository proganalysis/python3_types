...
class CoreachEncoder(Any):
    ...
    inputs: list
    last_allowed_states: List[int]
    max_k: int
    max_model_states: List[int]
    model_init_state: int
    parse_model: Any
    reach_func_desc: Any
    tau_desc: Any
    def __init__(self, automaton, tau_desc, inputs: Iterable, descr_by_output: dict, all_model_states: Iterable[int], max_k: int, model_init_state: int = ...) -> None: ...
