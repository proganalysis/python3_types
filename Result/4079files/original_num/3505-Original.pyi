...
class BuildRequest(object):
    ...
    def build(self, cmake_project_root_path: str, branding_options: list, dir_path: str, bs: BuildSystem, package_types: list, saver: ProgressSaver) -> List[str]: ...
...
class BuildSystem:
    ...
    name_: Any
    policy_: Any
    def __init__(self, name, cmd_line: list, cmake_generator_arg, policy) -> None: ...
