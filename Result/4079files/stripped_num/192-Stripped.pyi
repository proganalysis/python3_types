...
class LXD(Any):
    ...
    _container: Any
    _lxd_client: Any
    def __init__(self, *, project, echoer, is_ephemeral = ...) -> None: ...
    ...
    def _push_file(self, *, source, destination) -> None: ...
    def _run(self, command, hide_output = ...) -> Union[bytes, int]: ...
    def _start(self) -> None: ...
    def _stop(self) -> None: ...
    def clean_project(self) -> Any: ...
    def create(self) -> None: ...
    def destroy(self) -> None: ...
    @classmethod
    def ensure_provider(cls) -> None: ...
    def mount_project(self) -> None: ...
    def pull_file(self, name, destination, delete = ...) -> None: ...
    @classmethod
