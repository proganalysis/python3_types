...
class RF2Filter:
    ...
    def _proc_concept_row(self, row) -> bool: ...
    def _proc_definition_row(self, row) -> bool: ...
    def _proc_description_row(self, row) -> bool: ...
    def _proc_relationship_row(self, row) -> bool: ...
