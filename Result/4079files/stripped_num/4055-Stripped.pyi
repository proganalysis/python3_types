...
# Caught error in pytype: ParameterizedClass
...
#   File "/usr/local/lib/python3.6/dist-packages/pytype/vm.py", line 2035, in byte_STORE_ATTR
#     state = self.store_attr(state, obj, name, val)
#   File "/usr/local/lib/python3.6/dist-packages/pytype/vm.py", line 1345, in store_attr
#     state.node, val.data, attr, value))
#   File "/usr/local/lib/python3.6/dist-packages/pytype/attribute.py", line 163, in set_attribute
