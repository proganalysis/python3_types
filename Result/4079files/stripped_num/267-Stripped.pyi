...
class Tabulate:
    ...
    @staticmethod
    def classes(*args, labels = ...) -> List[Class]: ...
    def execute_table(self, _output_type, **kwargs) -> Any: ...
    @staticmethod
    def stat(*args, **kwargs) -> Statistic: ...
    @staticmethod
    def stats(*args, labels = ..., formats = ...) -> List[Statistic]: ...
    def table(self, **kwargs) -> Any: ...
    def text_table(self, **kwargs) -> None: ...
    def to_dataframe(self, **kwargs) -> Any: ...
    def to_nested_dataframe(self, code) -> Any: ...
    @staticmethod
    def vars(*args, labels = ...) -> List[Var]: ...
