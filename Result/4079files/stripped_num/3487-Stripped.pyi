...
def call_requests(requests, methods, debug) -> coroutine: ...
...
def dispatch_pure(request, methods, *, context, convert_camel_case, debug) -> coroutine: ...
def safe_call(request, methods, *, debug) -> coroutine: ...
