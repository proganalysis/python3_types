...
def draw_graph(draw, pic_pixels, aperture, spectrum_angle, wavelength_factor) -> Tuple[collections.OrderedDict[str, Any], Any]: ...
...
def find_aperture(pic_pixels, pic_width, pic_height) -> Dict[str, Any]: ...
