...
def complain(what, iwant_object) -> Dict[str, str]: ...
@overload
...
def solve_iwant_activity(iwant_object) -> Any: ...
def solve_iwant_behest(iwant_object) -> Any: ...
def verify_request_token(body) -> None: ...
