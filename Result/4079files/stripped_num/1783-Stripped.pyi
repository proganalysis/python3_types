...
class Host(Any):
    ...
    route: Tuple[str, str]
    server: Any
    def __init__(self, server, client, event, request) -> None: ...
    def comment(self, status) -> Coroutine[Any, Any, Optional[str]]: ...
    def current_label(self) -> coroutine: ...
    def labels_url(self, label = ...) -> coroutine: ...
    @classmethod
    def process(cls, server, request, client) -> coroutine: ...
    def remove_label(self) -> coroutine: ...
    def set_label(self, status) -> Coroutine[Any, Any, str]: ...
    def update(self, status) -> Coroutine[Any, Any, None]: ...
    def usernames(self) -> Coroutine[Any, Any, frozenset]: ...
