...
def plot(x, y, x_label, scalar, xmax = ..., ymin = ..., ymax = ...) -> None: ...
def plot_gym_monitor_stats(stats_path, xmax = ..., smoothing_function = ..., save_directory = ..., show_plots = ...) -> None: ...
def plot_tasks(data, x_label, smoothing_function = ..., xmin = ..., xmax = ..., max_reward = ..., legend = ..., save_directory = ..., show_plots = ...) -> None: ...
