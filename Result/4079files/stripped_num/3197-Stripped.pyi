...
class DBService:
    ...
    def query_table(self, table_name, quargs) -> Tuple[Any, list]: ...
...
def apply_column_sorts(query, table, join_table, sorts) -> Any: ...
def apply_group_by(query, table, join_table, group_by) -> Any: ...
def apply_join(query, table, join_table, join) -> Any: ...
