...
class AccountMethods:
    def end_takeout(self, success) -> Coroutine[Any, Any, bool]: ...
    def takeout(self, finalize = ..., *, contacts = ..., users = ..., chats = ..., megagroups = ..., channels = ..., files = ..., max_file_size = ...) -> _TakeoutClient: ...
