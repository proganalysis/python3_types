...
def direct_download(session, url, file, resume = ..., retry = ...) -> None: ...
def download_queue(session, download_list, queue_length = ...) -> None: ...
def generate_path(path_list) -> str: ...
def link_check(hostname, href) -> Any: ...
def mkdir_p(path, mode = ...) -> None: ...
def raw_unicode_escape(string) -> Any: ...
