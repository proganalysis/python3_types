...
from typing import Any, Generator, List, Pattern, Tuple, TypeVar
...
class BoxTable:
    ...
    def _format_row(self) -> Generator[str, Any, None]: ...
...
class ProgressBar:
    ...
    r_align: Any
    right_char: Any
    def __init__(self, coverage, message = ..., r_align = ..., fill_char = ..., empty_char = ..., left_char = ..., right_char = ...) -> None: ...
    def update(self, fill_amount) -> None: ...

def contract_user(path) -> str: ...
def get_path_ancestry(paths) -> list: ...
def secure_string(length) -> str: ...
def set_no_autocomplete() -> None: ...
def set_path_autocomplete() -> None: ...
def shell_cmd(input_cmd) -> subprocess.Popen[str]: ...
def timestamp_path(path, keyword = ...) -> str: ...
