...
class set_cookie(Any):
    ...
    def parse(self, field_value, add_note) -> Tuple[Any, Any, List[Tuple[str, Any]]]: ...

def loose_date_parse(cookie_date) -> int: ...
def loose_parse(set_cookie_string, uri_path, current_time, add_note) -> Tuple[Any, Any, List[Tuple[str, Any]]]: ...
