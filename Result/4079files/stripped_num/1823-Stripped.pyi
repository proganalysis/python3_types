...
class ProcessingPipeline:
    ...
    def load_features_and_preprocess(self, img_path, img_preprocessor) -> Tuple[numpy.ndarray, numpy.ndarray]: ...
    def load_model(self, model_path) -> None: ...
    def predict(self, x) -> Any: ...
    def save_model(self, model_save_path, include_stats = ...) -> None: ...
