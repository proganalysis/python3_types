...
class ProbeResult:
    ...
    def __init__(self, url: Any, is_media: Any, child_urls: Any) -> None: ...
...
class LinkScanResult:
    ...
    @property
    def total(self) -> int: ...
    def __init__(self, errors: Any, document_urls: Any, media_urls: Any, linkings: Any) -> None: ...
...
class DownloadStats:
    ...
    def __init__(self, total: Any, downloaded: Any, errors: Any) -> None: ...
