...
class ContactModel:
    ...
    @staticmethod
    def _correct_formating(data) -> Any: ...
    @staticmethod
...
class NameSilo:
    _base_url: str
    _token: Any
    def __init__(self, token, sandbox = ...) -> None: ...
