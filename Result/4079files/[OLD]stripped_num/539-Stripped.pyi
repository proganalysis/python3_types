...
import typing
from typing import Any, Dict, Generator, List, Pattern, Tuple, Type, TypeVar, Union
...
class Question:
    ...
    def to_example(self) -> Tuple[list, Any]: ...

class QuestionDatabase:
    _conn: sqlite3.dbapi2.Connection
    def __init__(self, location = ...) -> None: ...
    def all_answers(self) -> Dict[int, Any]: ...
    def all_questions(self, unfiltered = ...) -> Dict[Any, Question]: ...
    ...
    def query(self, command, arguments) -> Dict[Any, Question]: ...
    def questions_by_answer(self, answer) -> Generator[Question, Any, None]: ...
    def questions_with_pages(self) -> Dict[Any, List[Question]]: ...
...
class QuizBowlDataset:
    ...
    training_fold: str
    def __init__(self, min_class_examples, *, guesser_train = ..., buzzer_train = ..., qb_question_db = ...) -> None: ...
    def questions_by_fold(self, folds = ...) -> dict: ...
    def questions_in_folds(self, folds) -> list: ...
