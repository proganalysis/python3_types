...
import collections
from typing import Any, Callable, Generator, Iterable, Iterator, List, Tuple, Type, TypeVar, Union
...
def generate_paths(graph, feasible_paths = ..., debug = ...) -> List[Tuple[Any, Any]]: ...
