...
from typing import Any, Callable, Dict, NoReturn, Tuple, TypeVar
...
class MockKubernetes(Any):
    ResourceKey: type
    patch: Any
    resource_map: Dict[nothing, nothing]
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def add_resource(cls, resource, overwrite = ...) -> None: ...
    def get_or_none(self, resource_type, name, namespace = ...) -> None: ...
    @classmethod
    def make_key(cls, resource_type, name, namespace = ...) -> Any: ...
    @classmethod
    def resource_key(cls, resource) -> Any: ...
    def watch(self, resource_type) -> NoReturn: ...

def make_resource(resource_type, name, namespace = ..., labels = ..., annotations = ..., spec = ...) -> Any: ...
