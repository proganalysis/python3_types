...
def append_event(issue_uid, event_type, parameters = ...) -> None: ...
def append_event_chained_to(issue_uid, chained_to_these_issues) -> None: ...
def append_event_close(issue_uid) -> None: ...
def append_event_open(issue_uid, message) -> None: ...
def append_event_show(issue_uid) -> None: ...
def append_event_slug(issue_uid, slug) -> None: ...
def append_event_tagged(issue_uid, tags) -> None: ...
def read() -> Any: ...
