...
class ApiObjectList:
    ...
    def unwrap_api_object(self) -> Any: ...
...
class Message(OutApiObject):
    ...
    def inline_message_id(self: _TMessage, inline_message_id) -> _TMessage: ...
    ...
    def with_reply_markup(self: _TMessage, reply_markup) -> _TMessage: ...
