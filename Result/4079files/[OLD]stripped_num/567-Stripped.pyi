...
import collections
from typing import Any, Callable, Coroutine, Dict, Iterable, List, Sized, Tuple, Type, TypeVar, Union
...
class SmartThingsSensor(Any):
    ...
    def __init__(self, device, attribute, name, default_unit, device_class) -> None: ...
...
def get_capabilities(capabilities) -> list: ...
