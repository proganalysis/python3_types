...
#   File "/usr/local/lib/python3.6/dist-packages/pytype/analyze.py", line 377, in analyze_toplevel
#     new_node = self.analyze_class(node, value)
#   File "/usr/local/lib/python3.6/dist-packages/pytype/analyze.py", line 348, in analyze_class
#     node = self.analyze_method_var(node, name, b)
#   File "/usr/local/lib/python3.6/dist-packages/pytype/analyze.py", line 198, in analyze_method_var
...
#   File "/usr/local/lib/python3.6/dist-packages/pytype/abstract.py", line 3361, in call
