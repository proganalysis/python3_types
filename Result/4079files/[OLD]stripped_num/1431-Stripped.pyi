...
class ExampleClass:
    ...
    def __init__(self, an_int) -> None: ...
    @classmethod
    def classmethod_with_builtin_type_annotations(cls, an_int) -> None: ...
    def integration(self, an_int, a_string = ..., *, a_callable = ..., **kwargs) -> str: ...
    def method_with_class_names(self, an_object: _T0) -> _T0: ...
    def method_with_default_value(self, a_float, an_int = ..., an_str = ...) -> None: ...
    def method_with_default_value_for_self(self = ..., an_int = ...) -> None: ...
    def method_with_function_annotations(self, a_callable: _T0) -> _T0: ...
    def method_with_kwonly_arg(self, a_float, *, an_int) -> None: ...
    def method_with_varargs(self, an_int, *varargs, **varkwargs) -> None: ...
...
def function_with_annotated_varargs(an_int, *varargs, **varkwargs) -> None: ...
def function_with_complex_default_value(a_tuple = ...) -> None: ...
def function_with_mixed_types(something: _T0 = ...) -> _T0: ...
def function_with_named_tuple(a_tuple) -> None: ...
