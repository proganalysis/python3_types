...
def get_followed(user) -> List[str]: ...
def get_followers(user) -> List[str]: ...
def get_user(user) -> UserInfo: ...
def hash_password(password, salt: _T1 = ...) -> Tuple[bytes, Union[bytes, _T1]]: ...
...
def posts_by_user(user, limit = ...) -> List[Post]: ...
def posts_for_user(user, limit = ...) -> list: ...
def search(phrase, limit = ...) -> List[Post]: ...
def set_user(user, displayname, email, password, bio = ..., photo = ...) -> None: ...
