...
def equal(a, b) -> Any: ...
def find(obj, query, operator_str = ...) -> Generator[Any, Any, None]: ...
def greater(a, b) -> Any: ...
...
def matcher_level(value, query, operator_str) -> Any: ...
def resolve(func, query_value, value, operator_str) -> Any: ...
