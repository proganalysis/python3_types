...
#   File "/usr/local/lib/python3.6/dist-packages/pytype/vm.py", line 2377, in byte_CONTINUE_LOOP
#     self.store_jump(op.target, new_state)
#   File "/usr/local/lib/python3.6/dist-packages/pytype/vm.py", line 2353, in store_jump
#     self.frame.states[target] = state.merge_into(self.frame.states.get(target))
#   File "/usr/local/lib/python3.6/dist-packages/pytype/state.py", line 160, in merge_into
