...
from typing import Any, Callable, Coroutine, IO, List, Optional, TextIO
...
class Tester(AsyncTester):
    ...
    running_loop: asyncio.events.AbstractEventLoop
    time_track_stack: List[nothing]
    def do_multiple(self, func, times: int = ..., text: str = ...) -> Coroutine[Any, Any, int]: ...
