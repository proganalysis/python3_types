...
def parse_model_repr(repr_str: str) -> `namedtuple-ModelParameters-datetime-hostname-depth-width-days-dropout-optimizer-lr-normalized`: ...
def parse_model_repr_monthwise(repr_str: str) -> `namedtuple-ModelParameters-datetime-hostname-depth-width-month-dropout-optimizer-lr`: ...
def parse_model_repr_old(repr_str: str) -> `namedtuple-ModelParameters-datetime-hostname-depth-width-dropout-optimizer-lr-normalized`: ...
