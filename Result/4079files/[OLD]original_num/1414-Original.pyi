...
class CommandSerialization(ProtocolBase):
    ...
    def __init__(self, *args, packet_callback: Optional[Callable] = ..., **kwargs) -> None: ...
...
class EventHandling(PacketHandling):
    ...
    loop: asyncio.events.AbstractEventLoop
    packet: str
    packet_callback: Optional[Callable]
    def __init__(self, *args, event_callback: Optional[Callable] = ..., ignore: Optional[List[str]] = ..., **kwargs) -> None: ...
