...
def efetch(database, ids = ..., webenv = ..., query_key = ..., count = ..., retstart = ..., retmax = ..., rettype = ..., retmode = ..., api_key = ..., email = ..., **kwargs) -> str: ...
def elink(db: str, dbfrom: str, ids = ..., webenv = ..., query_key = ..., api_key = ..., email = ..., **kwargs) -> Optional[`namedtuple-EpostResult-dbfrom-dbto-webenv-query_key`]: ...
def entrez_sets_of_results(url, retstart = ..., retmax = ..., count = ...) -> Optional[List[requests.models.Response]]: ...
def entrez_try_get_multiple_times(url, num_tries = ...) -> Optional[requests.models.Response]: ...
def entrez_try_put_multiple_times(url: str, url_params: str, num_tries = ...) -> Optional[requests.models.Response]: ...
def epost(database, ids: List[str], webenv = ..., api_key = ..., email = ..., **kwargs) -> Optional[`namedtuple-EpostResult-webenv-query_key`]: ...
...
def esummary(database: str, ids = ..., webenv = ..., query_key = ..., count = ..., retstart = ..., retmax = ..., api_key = ..., email = ..., **kwargs) -> Optional[List[`namedtuple-EsummaryResult-id-accn-create_date-update_date`]]: ...
def namedtuple(typename: str, field_names: Union[str, Iterable[str]], *, verbose: bool = ..., rename: bool = ...) -> type: ...
def parse_epost(xml: str) -> `namedtuple-EpostResult-webenv-query_key`: ...
def parse_esummary(xml: str) -> List[`namedtuple-EsummaryResult-id-accn-create_date-update_date`]: ...
