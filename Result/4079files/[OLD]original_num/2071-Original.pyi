...
def get_read_dates(soup) -> List[Tuple[datetime.datetime, datetime.datetime]]: ...
def main() -> None: ...
def make_book_url(book_id: str) -> AbsoluteUrl: ...
def make_review_url(review_link: str) -> AbsoluteUrl: ...
def parse_csv(filename: Path) -> List[collections.OrderedDict[str, str]]: ...
def sign_in(email: str, password: str) -> requests.sessions.Session: ...
