...
class NeulionScraperApi(common.VideoProvider):
    ...
    def available_dates(self, start_date: datetime.date, end_date: datetime.date) -> Iterable: ...
    def clips(self, for_date: datetime.date, project_ids) -> Generator[NeulionClipMetadata, Any, None]: ...
    def download(self, url, destination_dir) -> None: ...
    def get_metadata(self, for_date) -> Iterable[common.VideoMetadata]: ...
    def postprocess(self, video_metadata: common.VideoMetadata, download_dir, destination_dir, **kwargs) -> common.PreparedVideoInfo: ...
...
def group_root_and_subclips(clips: List[common.VideoMetadata]) -> collections.OrderedDict[common.VideoMetadata, List[common.VideoMetadata]]: ...
...
def shift_timecodes(timecodes: List[common.TimeCode], relative_to: str) -> None: ...
