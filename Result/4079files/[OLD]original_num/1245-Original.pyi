...
def is_officer_mode(server: int) -> Any: ...
def is_user_officer(roles: list) -> bool: ...
def logActivity(message: str, user: str) -> None: ...
def paginate(data) -> Any: ...
def print_error(error: Exception, message = ...) -> None: ...
def send_or_display(server: int, author, bot, content) -> Coroutine[Any, Any, None]: ...
def test_list() -> None: ...
