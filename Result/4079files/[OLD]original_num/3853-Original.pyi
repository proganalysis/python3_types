...
class GameMode(enum.Enum):
    ...
    __doc__: str
    @classmethod
    def get_mode(cls, mode: str) -> Optional[enum.Enum]: ...
...
class Mods(enum.Enum):
    ...
    @classmethod
    def list_mods(cls, bitwise: int) -> list: ...
...
def beatmap_from_url(url: str, mode: GameMode = ..., *, return_type: str = ...) -> coroutine: ...
def beatmapset_from_url(url: str) -> coroutine: ...
def def_section(api_name: str, first_element: bool = ...) -> Callable: ...
def get_beatmaps(url = ..., request_tries: int = ..., **params) -> coroutine: ...
def get_match(url = ..., request_tries: int = ..., **params) -> coroutine: ...
def get_replay(url = ..., request_tries: int = ..., **params) -> coroutine: ...
def get_scores(url = ..., request_tries: int = ..., **params) -> coroutine: ...
def get_user(url = ..., request_tries: int = ..., **params) -> coroutine: ...
def get_user_best(url = ..., request_tries: int = ..., **params) -> coroutine: ...
def get_user_recent(url = ..., request_tries: int = ..., **params) -> coroutine: ...
def lookup_beatmap(beatmaps: list, **lookup) -> Any: ...
def namedtuple(typename: str, field_names: Union[str, Iterable[str]], *, verbose: bool = ..., rename: bool = ...) -> type: ...
def parse_beatmap_url(url: str) -> `namedtuple-BeatmapURLInfo-beatmapset_id-beatmap_id-gamemode`: ...
def rank_from_events(events: dict, beatmap_id: str) -> Optional[int]: ...
def set_api_key(s: str) -> None: ...
