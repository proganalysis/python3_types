...
class Polygon:
    ...
    def getMinkowskiHull(self: _TPolygon, other: _TPolygon) -> _TPolygon: ...
    def getMinkowskiSum(self: _TPolygon, other: _TPolygon) -> _TPolygon: ...
    def getPoints(self) -> Any: ...
    def intersectionConvexHulls(self: _TPolygon, other: _TPolygon) -> _TPolygon: ...
    ...
    def unionConvexHulls(self: _TPolygon, other: _TPolygon) -> _TPolygon: ...
